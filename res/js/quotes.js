...
* @version 1.0.0
* @author weberstudio.net@gmail.com
* @provider http://weberstudio.net
* @description A light weight widget for adding random quotes to staticly served documents.
*/
(function(ref){
  // Prevent auto execution in the event object exists
  if(ref.hasInitialised) return;
  var quotes = {
